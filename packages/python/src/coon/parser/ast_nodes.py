...
def create_root_node() -> ASTNode:
    ...
    return ASTNode(node_type="root", value=None, line=1, column=1)
...
def create_class_node(
    ...
    return ASTNode(node_type="class", value=name, properties=props, line=line, column=column)
...
def create_function_node(
    ...
    return ASTNode(node_type="function", value=name, properties=props, line=line, column=column)


def create_variable_node(
    name: str, modifier: str = "var", var_type: Optional[str] = None, line: int = 0, column: int = 0
) -> ASTNode:
    """
    ...
    return ASTNode(node_type="variable", value=name, properties=props, line=line, column=column)
...
def create_import_node(
    ...
    return ASTNode(node_type="import", value=path, properties=props, line=line, column=column)
